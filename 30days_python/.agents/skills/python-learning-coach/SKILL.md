...
- **Spaced Batched Recall**: Recall challenges are batched at the end of an exercise level or every 3 exercises to enforce true cognitive retrieval rather than short-term rote copying.
