...
def generate_full_name (first_name, last_name):
    ...
    full_name = first_name + space + last_name
    return full_name
print('Full Name: ', generate_full_name('Bing', 'Bong'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print_fullname(firstname = 'Bing', lastname = 'Bong')
...
def print_full_name(firstname, lastname):
    ...
    return full_name
    print_full_name(firstname='Soggy', lastname='Boi')
'''
